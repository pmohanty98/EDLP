...
def main(args):
    ...
    d = torch.load("{}/best_ckpt_{}_{}_{}_{}_{}.pt".format(args.save_dir,args.dataset_name,args.eval_sampler,args.eval_step_size, args.eval_step_size_a, args.eval_eta))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--buffer_size', type=int, default=10000) #Caltech is 1000
    ...
    parser.add_argument('--eval_step_size_a', type=float, default=0.08)
    parser.add_argument('--eval_eta', type=float, default=1)
    # training
