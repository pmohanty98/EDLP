    ...
    if args.sampler == "gibbs":
        ...
        if "potts" in args.model:
            ...
            sampler = samplers.ELangevinSampler(model.data_dim, 1,
                                           fixed_proposal=False, approx=True, multi_hop=False, temp=2., alpha=0.1, alpha_a=0.4, mh=False,eta=0.2)
    elif args.sampler == "edula-glu":
            sampler = samplers.ELangevinSamplerwithGLU(model.data_dim, 1,
                                           fixed_proposal=False, approx=True, multi_hop=False, temp=2., alpha=0.1, mh=False,eta=0.2)
            ...
            sampler = samplers.ELangevinSampler(model.data_dim, 1,
                                           fixed_proposal=False, approx=True, multi_hop=False, temp=2., alpha=0.2, alpha_a=args.alpha_a, mh=True,eta=args.eta)
            #alpha_a=3*1088-3
            #<0.1,1000>
    elif args.sampler == "edmala-glu":
            sampler = samplers.ELangevinSamplerwithGLU(model.data_dim, 1,
                                           fixed_proposal=False, approx=True, multi_hop=False, temp=2., alpha=0.2,  mh=True,eta=args.eta)


    elif args.sampler == 'egdmala':
        sampler = samplers.EGLangevinSampler(model.data_dim, 10,
                                             fixed_proposal=False, approx=True, multi_hop=False, temp=2.,
                                             alpha=0.2, mh=True, eta=args.eta, score_sweeps=4)
    elif args.sampler == 'egdula':
        sampler = samplers.EGLangevinSampler(model.data_dim, 10,
                                             fixed_proposal=False, approx=True, multi_hop=False, temp=2.,
                                             alpha=0.1, mh=False, eta=args.eta, score_sweeps=4)
