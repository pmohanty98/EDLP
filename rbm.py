...
class LatticeIsingModel(nn.Module):
    def __init__(self, dim, init_sigma=.15, init_bias=0., learn_G=False, learn_sigma=False, learn_bias=False,
        ...
        # Create the adjacency matrix with tuned weights
        #W_tuned = next_nearest_neighbor_adjacency(2, flat_regions=flat_regions, sharp_regions=sharp_regions)
